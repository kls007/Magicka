...
public class Packager {
    ...
    static void HandleExampleBundle() {
        ...
        AddBuildMap("hud" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/HUD");
        AddBuildMap("startupscreen" + AppConst.ExtName, "*.prefab", "Assets/LuaFramework/Examples/Builds/StartupScreen");
